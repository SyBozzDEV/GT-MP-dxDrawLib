...
let testProgressBar: DxProgressBar;
...
API.onResourceStart.connect(function() {
	...
	testCheckbox1 = new DxCheckbox("Checkbox", 0.1, 0, 0.1, 0.1, true, true, null, testWindow);
	testCheckbox2 = new DxCheckbox("Checkbox", 0.1, 0.11, 0.2, 0.1, false, true, null, testWindow);
    
	testRadioButton3 = new DxRadioButton("RadioButton", "key_1", 0.1, 0.5, 0.17, 0.1, true, true, new Color(255, 0, 255, 0), testWindow);
	testRadioButton4 = new DxRadioButton("RadioButton", "key_1", 0.1, 0.61, 0.1, 0.1, true, true, new Color(255, 0, 255, 0), testWindow);
