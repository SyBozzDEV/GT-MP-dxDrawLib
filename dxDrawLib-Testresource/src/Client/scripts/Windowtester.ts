...
var testRadioButton = new DxRadioButton("RadioBtn", "key_1", 0.1, 0.5, 0.2, 0.1, false, true, new Color(255, 0, 255, 0), testWindow);
var testRadioButton2 = new DxRadioButton("RadioBtn", "key_1", 0.1, 0.61, 0.2, 0.1, false, true, new Color(255, 0, 255, 0), testWindow);
